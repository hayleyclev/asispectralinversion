...
starttime = '101900' # time in the format of HHMMSS
endtime = '101930' # time in the format of HHMMSS

maglatsite = 65.8 # site of camera in magnetic latitude

lambdas = ['0428', '0558', '0630'] # wavelengths (nm) of imager filters

folder = '/Users/clevenger/Projects/paper01/sop23_data/202302/27/asi/crossing2/in/' # folder that holds all image files and GLOW outputs for an hour's worth of an event
base_outdir = '/Users/clevenger/Projects/paper01/sop23_data/202302/27/asi/crossing2/out' # output directory to store all output figures and h5s
output_txt = '/Users/clevenger/Projects/paper01/sop23_data/202302/27/asi/crossing2/out/time_ranges.txt' # output for txt file that shows time cadence
